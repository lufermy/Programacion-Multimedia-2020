package practicas.simarro.aplicacionbanco;
...
import practicas.simarro.aplicacionbanco.bd.MiBD;
import practicas.simarro.aplicacionbanco.bd.MiBancoOperacional;
import practicas.simarro.aplicacionbanco.pojo.Cliente;
import practicas.simarro.aplicacionbanco.pojo.Cuenta;
import practicas.simarro.aplicacionbanco.pojo.Movimiento;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(b==null){
            ...
            txtdatos.append("Error: Ha podido loguearse con la password anterior. Es necesario revisar el código.\n");
            txtdatos.append("\n");
        }
